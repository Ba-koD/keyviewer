...
# Builds only the installer version (PyInstaller)
...
$buildName = "KBQV-Installer-$version"
...
Write-Host "===============================================" -ForegroundColor Cyan
Write-Host "Step 1: Installer Build (PyInstaller onefile)" -ForegroundColor Yellow
Write-Host "===============================================" -ForegroundColor Cyan
...
try {
    ...
    & $pythonCmd -m PyInstaller --clean --onefile --noconsole --name $buildName --icon "web/favicon.ico" --distpath "dist" --workpath "build" --hidden-import "tkinter" --hidden-import "tkinter.ttk" --hidden-import "tkinter.messagebox" --hidden-import "tkinter.filedialog" --hidden-import "pathlib" --hidden-import "subprocess" --hidden-import "threading" --hidden-import "urllib.request" --hidden-import "json" --hidden-import "zipfile" --hidden-import "tempfile" installer.py
    ...
    Write-Host "   3. Check if installer.py file exists" -ForegroundColor White
